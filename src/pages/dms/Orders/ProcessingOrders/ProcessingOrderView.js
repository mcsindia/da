...
export const ProcessingOrderView = () => {
        ...
        return (
            <AdminLayout>
                <div className="text-center p-5">
                    <h4>No Processing Order Details Available</h4>
                    <Button onClick={() => navigate('/dms/processing-orders')}>Back to Processing Orders</Button>
                </div>
            </AdminLayout>
        );
    }
        ...
        <AdminLayout>
            <div className="dms-container p-3">
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <h3>Processing Order Details</h3>
                ...
                <Card className="mb-4">
                    <Card.Body>
                        ...
                        <p><strong>Processing Start Date:</strong> {order.processingStartDate}</p>
                        <p><strong>Estimated Completion:</strong> {order.estimatedCompletion}</p>
